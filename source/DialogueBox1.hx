...
class DialogueBox extends FlxSpriteGroup
{
	...
	{
		super();
		//J: NOTE TO SELF: SONG.song MAY HAVE A SPACE IN THE SONG, SO DO *NOT* PUT A DASH, PUT A SPACE
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'power on':
				...
				trace("J: maybe it's just being retarded or im being retarded idk lol");
